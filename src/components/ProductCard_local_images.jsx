  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="relative h-64 bg-gray-100 overflow-hidden group">
        ...
        {/* Brand Badge */}
        {product.brand && (
          <div className="absolute top-2 right-2 bg-orange-500 text-white px-2 py-1 rounded text-sm font-semibold z-10">
            {product.brand}
          </div>
        )}
      ...
      <div className="p-4">
        ...
        {/* Add to Cart Button */}
        <button className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded transition-colors duration-200">
          Add to Cart
        </button>
      </div>
    </div>
